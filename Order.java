...
public class Order {
    ...
    public void set_tax_rate(String rate)
    {
        BigDecimal a = new BigDecimal(rate);
        this.TaxRate = a.setScale(2, RoundingMode.HALF_UP);
    }
    ...
    public void set_area(String area)
    {
        ...
        this.area = a.setScale(2, RoundingMode.HALF_UP);
    }
    public BigDecimal get_area()
    {
        return this.area;
    }
    public void set_cost_per_square_foot(String cost)
    {
        BigDecimal a = new BigDecimal(cost);
        this.CostPerSquareFoot = a.setScale(2, RoundingMode.HALF_UP);
    }
    public BigDecimal get_cost_per_square_foot()
    {
        return this.CostPerSquareFoot;
    }
    public void set_labor_cost_per_square_foot(String cost)
    {
        BigDecimal a = new BigDecimal(cost);
        this.LaborCostPerSquareFoot = a.setScale(2, RoundingMode.HALF_UP);
    }
